        ...
        for (let i = 0; i < topPlayers.length; i += batchSize) {
            ...
            const batchPromises = batch.map(async (player) => {
                try {
                    ...
                    // Get summoner data to get PUUID (na1 region) - instructions from https://developer.riotgames.com/docs/lol
                    ...
                    // Use PUUID to get Riot ID (americas region) - instructions from https://developer.riotgames.com/docs/lol
                    await delay(BATCH_DELAY);
                    ...
                    const processedPlayer = {
                        ...
                        name: accountInfo.gameName, 
                        riotId: riotId, // Full Riot ID, in case needed in future
